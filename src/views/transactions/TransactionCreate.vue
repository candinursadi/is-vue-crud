...
const { storeTransaction, errors } = useTransactions()
...
<template>
    <form action="" class=" max-w-md mx-auto p-4 bg-gray-50 shadow-md rounded-md" @submit.prevent="storeTransaction(form)">
        <div class=" space-y-6">
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input type="email" id="email" v-model="form.email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="mb-6">
                ...
                <input type="number" id="amount" v-model="form.amount" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
